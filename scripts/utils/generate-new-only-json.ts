...
const str = JSON.stringify(newOnlyJson, null, 2);
fs.writeFileSync("graylog_extractors_new_only.json", str);
console.log("Saved NEW ONLY extractors JSON (length:", str.length, ")");
