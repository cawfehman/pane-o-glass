            ...
            <div style={{ padding: '24px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
                    ...
                    <div>
                        ...
                        <p title="The 3-character site identifier extracted from AP name"><strong>Site Code:</strong> <span style={{ color: 'var(--accent-secondary)', fontWeight: 'bold' }}>{failure.site_code || "N/A"}</span></p>
