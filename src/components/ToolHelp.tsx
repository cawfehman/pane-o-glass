...
export const helpData: Record<string, TooltipDetails> = {
    ...
    'vpn-reporting': {
        ...
        capabilities: [
            ...
            },
            {
                ...
                detail: "Supports complex boolean search logic with parentheses, AND/OR/NOT operators, and prefix exclusion—e.g. '(smith-jane OR doe-john) AND NOT 10.20.30.40' or 'comcast -10.20.30.40'—or simple comma/space delimited lists.",
    ...
    ironport: {
        ...
        colors: [
            { name: "🚨 FAKE M365 PORTAL", meaning: "External domain mimicking Microsoft branding (+10.0 Priority Score Boost).", rgb: "#ef4444" },
            { name: "⚠️ OAUTH TOKEN THEFT VECTOR", meaning: "External link to devicelogin or M365 form used to steal auth tokens (+6.0 Priority Score Boost).", rgb: "#f97316" },
